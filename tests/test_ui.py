...
class TestDisplayTrends:
    ...
    def test_display_trends(self, capsys):
        """Test trends display."""
        stats = {"session_count": 10, "unique_files": 50, "open_risks": 5, "unique_commands": 20}
        ...
        recurring_risks = [{"session_count": 3, "status": "open", "description": "Test risk"}]

        commands = [{"total_mentions": 10, "command": "pytest"}]
...
class TestDisplayQueryResults:
    ...
    def test_display_query_results(self, capsys):
        ...
        result.row_count = 2
        result.results = [{"id": 1, "name": "Test 1"}, {"id": 2, "name": "Test 2"}]
...
class TestDisplayPredictions:
    ...
    def test_display_predictions_impact(self, capsys):
        ...
        prediction.predictions = [{"file": "test.py", "confidence": 0.9, "co_changes": 5}]
    ...
    def test_display_predictions_risks(self, capsys):
        ...
        prediction.predictions = [{"status": "open", "risk": "Test risk", "frequency": 3}]
    ...
    def test_display_predictions_tests(self, capsys):
        ...
        prediction.predictions = [{"test_file": "test_main.py", "reason": "Tests main.py"}]
